$(document).ready(function(){
    ...
    $('#tblLoanPend, #tblLoan, #tblReserv').DataTable();
    ...
    $('.search-book-button').click(function(e){
        ...
        swal({
           title: "¿Qué ruta estás buscando?",
           text: "Por favor escribe el número de ruta",
           type: "input",
           showCancelButton: true,
           closeOnConfirm: false,
           animation: "slide-from-top",
           ...
           inputPlaceholder: "Escribe aquí el número de la ruta" },
      function(inputValue){
           if (inputValue === false) return false;

           if (inputValue === "") {
               swal.showInputError("Debes escribir el número de la ruta");
               return false;
           }
            ...
            success:function(data){
                if(data==="Avaliable"){
                    ...
                    swal({
                       ...
                       text:"No puedes registrar rutas por el momento, primero debes de agregar los datos de la institución, rutas y categorías. Ve a la opción Administración del menu",
                       type: "error",
