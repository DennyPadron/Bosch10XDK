$(document).ready(function(){
    ...
    var MsjSending='<div class="responseProcess"><div class="container-loader"><div class="loader"><svg class="circular"><circle class="path" cx="50" cy="50" r="20" fill="none" stroke-width="2" stroke-miterlimit="10"/></svg></div><p class="text-center lead">Procesando <span id="infoDataProcess"></span>... Un momento por favor</p></div></div>';
    ...
    $("#saveData").on("submit", function(e){
        ...
        swal({
            title: "¿Quieres almacenar los datos?",
            text: "Los datos se almacenaran en el sistema",
            type: "info",
            showCancelButton: true,
                ...
                xhr: function(){
                    ...
                    xhr.upload.addEventListener("progress", function(evt) {
                      if (evt.lengthComputable) {
                        ...
                        $('#infoDataProcess').html('('+percentComplete+'%)');
                      }
                    }, false);
                    return xhr;
                },
